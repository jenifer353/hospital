...
$data = [
  ...
  "remove_user" => [
    ...
    'input' => "Ви дійсно бажаєте видалити пацієнта <b>NULL</b> з бази даних?"
  ],
  "remove_person" => [
    'action' => 'remove',
    'title' => "Видалення лікаря зі списку",
    'input' => "Ви дійсно бажаєте видалити лікаря <b>NULL</b>?"
  ],
  "remove_hvoroba" => [
    'action' => 'remove',
    'title' => "Видалення хвороби зі списку",
    'input' => "Ви дійсно бажаєте видалити хворобу <b>NULL</b>?"
  ],
  "remove_entry" => [
    'action' => 'remove',
